  ...
  if(isset($_POST['upate_veh']))
    {
            ...
            $rc=$stmt->bind_param('sssssi', $v_name, $v_reg_no, $v_driver, $v_category, $v_status, $v_id);
            $stmt->execute();
                if($stmt)
                {
        ...
        ?>
          <form method ="POST" enctype="multipart/form-data"> 
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $row->v_name;?>" class="form-control"  id="exampleInputEmail1" name="v_name">
            </div>
            <div class="form-group">
