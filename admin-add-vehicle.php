  ...
  if(isset($_POST['add_veh']))
    {
            ...
            $query="insert into tms_vehicle (v_name, v_reg_no,v_ton, v_driver, v_category, v_status ) values(?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssss', $v_name, $v_reg_no,$v_ton, $v_driver, $v_category, $v_status);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "Vehicle Added";
        ...
        <div class="card-body">
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="v_ton">
            </div>
            <div class="form-group">
