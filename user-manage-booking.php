              ...
              <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                ?>
                 <tr>
                    ...
                    <td><a href="user-cancel-booking.php?u_book_id=<?php echo $row->u_book_id;?>" class="badge badge-danger"><i class ="fa fa-trash"></i> Cancel Booking</a></td>
                  </tr>
