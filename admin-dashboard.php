            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $result ="SELECT count(*) FROM tms_booking where u_book_status = 'Approved' || u_book_status = 'Pending' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                  ...
                  $ret="SELECT * FROM `tms_booking` as tb JOIN tms_user as tu ON tb.users_id=tu.u_id WHERE tb.u_book_status = 'Approved' || tb.u_book_status = 'Pending'"; //get all bookings
                ...
                ?>
                  <tr>
                    ...
                    <td><?php if($row->u_book_status == "Pending" || $row->u_book_status == "Canceled"){ echo '<span class = "badge badge-warning">'.$row->u_book_status.'</span>'; } else { echo '<span class = "badge badge-success">'.$row->u_book_status.'</span>';}?></td>
