...
//                 $stmt = $conn->prepare("INSERT INTO tms_user (u_fname, u_lname, u_phone,u_addr,u_category,u_email,u_pwd)
//                 VALUES (:u_fname,:u_lname,:u_phone,:u_addr,:u_category,:u_email,:u_pwd)");
//                 $stmt->bindParam(':u_fname', $u_fname);
//                 $stmt->bindParam(':u_lname', $u_lname);
//                 $stmt->bindParam(':u_phone', $u_phone);
//                 $stmt->bindParam(':u_addr', $u_addr);
//                 $stmt->bindParam(':u_category', $u_category);
