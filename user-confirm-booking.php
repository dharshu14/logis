  ...
  if(isset($_POST['book_vehicle']))
    {
            ...
            $u_book_status="Pending";
            $u_tons=$_POST['u_tons'];
            $query= "INSERT INTO tms_booking (users_id,u_vehicle_number, u_driver_name, u_source, u_destination, u_book_date, u_book_status,u_tons) VALUES (?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('issssssi', $u_id,$u_vehicle_number, $u_driver_name, $u_source, $u_destination, $u_book_date, $u_book_status,$u_tons);
            $stmt->execute();
                if($stmt)
                {
      ...
      <?php if(isset($succ)) {?>
        ...
        ?>
          ...
          <div class="form-group">
                ...
                <input type="text" value="<?php echo $row->v_reg_no;?>" readonly class="form-control" name="u_vehicle_number">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Tons</label>
                <input type="text"class="form-control" readonly value="<?php echo $row->v_ton;?>" name="u_tons">
            </div>
          <div class="form-group">
                <label for="exampleInputEmail1">Driver Name</label>
                <input type="text" value="<?php echo $row->v_driver;?>" readonly class="form-control" name="u_driver_name">
            </div>
            <div class="form-group">
